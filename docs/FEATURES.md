...
| Tool-call parsers | ✅ 38 families; historical OpenAI argument normalization `GATING` under [#526](https://github.com/mudler/vllm.cpp/issues/526) (CPU RED/GREEN on this head; live Gemma gate pending) | ✅ | ✅ | ◐ |
